...
- When using unfamiliar libraries, append "use context7" to get real-time docs
...
- Use `/new-project` skill for scaffolding templates (FINAL_GOAL.md, ARCHITECTURE.md, WORKLOG.md)
...
2. Run `/new-project` to scaffold docs (FINAL_GOAL.md, ARCHITECTURE.md, WORKLOG.md)
