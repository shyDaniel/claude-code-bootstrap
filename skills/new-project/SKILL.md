---
name: new-project
description: Scaffold a new project with FINAL_GOAL.md, ARCHITECTURE.md, and WORKLOG.md
user_invocable: true
---

# New Project Scaffolding

When the user invokes `/new-project`, create the following files in the current working directory:
...
2. Make an initial commit: `git commit -m "chore: scaffold project with docs"`
3. Ask the user to describe their project so you can fill in the templates
